...
public class ResponseCode implements java.io.Serializable {
    ...
    public static final ResponseCode OK = new ResponseCode(_OK);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://webservicesV2.bookcyprus.com/", "ResponseCode"));
    }
    /**
