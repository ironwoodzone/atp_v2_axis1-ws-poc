/**
 * TransferSearchLocationRequest.java
 *
...
public class TransferSearchLocationRequest  implements java.io.Serializable {
    private com.bookcyprus.webservicesV2.RequestBase baseRequest;

    private int startingPointId;

    public TransferSearchLocationRequest() {
    }
    ...
    /**
     * Gets the baseRequest value for this TransferSearchLocationRequest.
     * 
     * @return baseRequest
     */
    ...
    /**
     * Sets the baseRequest value for this TransferSearchLocationRequest.
     * 
     * @param baseRequest
     */
    ...
    /**
     * Gets the startingPointId value for this TransferSearchLocationRequest.
     * 
    ...
    /**
     * Sets the startingPointId value for this TransferSearchLocationRequest.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof TransferSearchLocationRequest)) return false;
        TransferSearchLocationRequest other = (TransferSearchLocationRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(TransferSearchLocationRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://webservicesV2.bookcyprus.com/", "TransferSearchLocationRequest"));
