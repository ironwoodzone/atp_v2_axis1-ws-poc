...
public class AccountDetailsRequest  implements java.io.Serializable {
    ...
    /**
     * Gets the baseRequest value for this AccountDetailsRequest.
     * 
     * @return baseRequest
     */
    ...
    /**
     * Sets the baseRequest value for this AccountDetailsRequest.
     * 
     * @param baseRequest
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://webservicesV2.bookcyprus.com/", "AccountDetailsRequest"));
